...
View(dt)
# redefine treatment as no_units > 75
...
dt[, treat_change := cumsum(no_units > 75), by = census_t_1]
sum(dt$no_units)
...
dt_est = dt
dt_est[, treat_change := cumsum(no_units > 75), by = census_t_1]
sum(dt_est$no_units)
...
saveRDS(dt_gsynth, "./4_code/gsynth_dt/dt_gsynth_big.rds")
